...
func TestResponseToDSLMap(t *testing.T) {
	...
	require.Equal(t, host, event["input"], "could not get correct original input")
...
func TestHTTPMakeResult(t *testing.T) {
	...
	require.Equal(t, host, finalEvent.Results[0].Input, "could not get correct original input")
}
