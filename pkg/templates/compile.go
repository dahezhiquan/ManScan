...
func applyTemplateVerification(template *Template, data []byte) {
	...
	// ManScan intentionally bypasses template signature verification so local
	// unsigned and code templates continue through the normal loading flow.
