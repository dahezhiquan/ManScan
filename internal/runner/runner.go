...
import (
	...
	"ManScan/internal/colorizer"
	"ManScan/internal/httpapi"
	"ManScan/pkg/catalog"
	"ManScan/pkg/catalog/config"
	"ManScan/pkg/catalog/disk"
	"ManScan/pkg/catalog/loader"
	"ManScan/pkg/core"
	"ManScan/pkg/external/customtemplates"
	...
	"ManScan/pkg/protocols/common/honeypotdetector"
	...
	"ManScan/pkg/protocols/common/uncover"
...
func versionInfo(cfg *config.Config, colorizer *aurora.Aurora, version, latestVersion, versionType string) string {
	return fmt.Sprintf("Current %s version: %v", versionType, version)
}
